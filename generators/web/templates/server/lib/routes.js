...
var ping_config = require('./common/routes/ping.js'),
    // auth_config = require('./common/routes/auth.js'),
    ...
    views_config = require('./common/routes/views.js'),
...
var endpoints = [
  ...
  {method: 'GET', path: '/views/{param*}', config: views_config.views},
  {method: 'GET', path: '/i18n/{param*}', config: i18n_config.i18n},

  // Login/Logout
  // {method: ['GET', 'POST'], path: '/login', config: auth_config.login},
  // {method: 'GET', path: '/logout', config: auth_config.logout},
 ...
 */
internals.prefixPaths = function(endpoints) {
